...
| `issuer`   | Кем было создано данное состояние модерации                 | [`Author`](#объект-автора-повязки) |
...
| `tags`        | Массив имен тегов                                                                                                 | `string[]` |      Да      | -                         |
