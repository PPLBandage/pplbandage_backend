...
- Документация к API
  ...
  - [Аутентификация (Auth)](/docs/auth.md)
  - [Пользователи (Users)](/docs/users.md)
  - [Мастерская (Workshop)](/docs/workshop.md)
  - [Minecraft API](/docs/minecraft.md)
  - [Подключения OAuth (Connections)](/docs/connections.md)
  - [Аватары (Avatars)](/docs/avatars.md)
  - [Эмоции (Emotes)](/docs/emotes.md)
  - [Административные функции (Admin)](/docs/admin.md)

## Введение
**API PPLBandage — это RESTful API, позволяющий приложениям взаимодействовать с серверами и базой данных проекта.**  

> [!NOTE]
> Документация актуализирована для версии API v1. Последнее обновление: 2025-02-15.
...
| ---------------------------------------------------------- | ------------------------------- |
| `GET /api/v1/ping`                                         | Нет                             |
| `POST /api/v1/feedback`                                    | `1rpm`                          |
| `POST /api/v1/error-report`                                | `5rpm`                          |
| `POST /api/v1/workshop`                                    | `1 запрос в 10 секунд`          |
| `POST /api/v1/workshop/:id/view`                           | `1rpm` (на уникальный IP+ID)    |
| `POST /api/v1/users/@me/connections/minecraft/cache/purge` | `5rpm`                          |
| `GET /api/v1/minecraft/suggest`                            | `300rpm`                        |
...
curl https://pplbandage.ru/api/v1/ping

# Получение списка повязок
curl https://pplbandage.ru/api/v1/workshop?take=5

# Получение скина игрока Minecraft
curl https://pplbandage.ru/api/v1/minecraft/skin/Notch
```